...
- Результаты верификации (run-log флипов ручных кейсов) фиксируются in-place в `tracks/<id>/test-cases.md` трека; содержательные решения и обоснования — в секции `## Решения и обоснования` `tracks/<id>/summary.md`
