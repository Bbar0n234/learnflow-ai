...
| Модель | Opus |
| Вход | `tracks/*/summary.md` (вкл. `## SOFA-посты`), `design-brief.md` (вкл. `## SOFA consulted`), `decisions.md`/ADR, `tracks/*/plan.md`, diff итерации, skill `sofa-contributor` |
...
| Модель | Sonnet |
| Вход | `tracks/*/summary.md` (секция `## Follow-ups` каждого трека), `harvest-proposals.md` (anytime-кандидаты, если есть), `decisions.md`, `review-a.md`/`review-b.md`, diff, `doc/backlog.md` |
