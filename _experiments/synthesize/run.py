...
def main():
    ...
    print(f"📝 Экзаменационный вопрос:")
    ...
    try:
        ...
        if DO_RECOGNITION:
            ...
            if not lecture_notes:
                ...
                lecture_notes = "Конспекты не были распознаны или отсутствуют изображения"
        else:
        ...
        if DO_GENERATION:
            ...
            print("="*40)
            additional_material = generate_additional_material(EXAM_QUESTION, client, prompts_config)
        else:
