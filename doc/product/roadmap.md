...
Скиллы всплывают по реальным потребностям: личный стиль/воркфлоу кристаллизуется в скиллы, часть → обязательный bundle, часть — project-specific или внешние. План итераций фазы — [tasklist-dogfooding](../tasks/tasklist-dogfooding.md): инструменты догфудинга (file attachments, PDF-экспорт, слайды, модели), execution runtime как общий фундамент выходных форматов, ГОСТ-скилл (первый bundle-скилл со студенческим оффером), OAuth; кастомные скиллы, web search, voice — за гейтом показа.
