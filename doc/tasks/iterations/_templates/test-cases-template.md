...
> Пишет **test-author**. Что покрываем автотестом (поведения, слои по модели «слой → тип теста»),
> что осознанно **не** покрываем и почему, замеченные прод-баги для fixer'а. Автотесты живут в
