...
## Открытые вопросы (остаток после Гейта 1 → на Гейт 2)

Исходные шесть вопросов Гейта 1 закрыты решениями выше (механизм custom-канала, payload `security_block`, reasoning в истории, typed parts, имена инструментов). Остаток:

1. **Глубина субагентного прогресса** — вкусовой выбор на мокапах Гейта 2: (а) одна живая карточка «работает судья · 1:47» vs (б) карточка с вложенной хронологией действий субагента. Оба варианта технически достижимы custom-каналом.
2. **Состав фазового enum** для индикатора вне карточек — рабочий дефолт `{подготовка, рассуждает, инструмент, пишет, проверка}`; уточняется на мокапах вместе с формулировками подписей.
