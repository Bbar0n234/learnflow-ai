...
**Статус:** 🚧 In Progress — проработка и реализация в [design-brief.md](iterations/codebase-maturity/feat-008-enforcement/design-brief.md)
...
- [ ] Pre-commit gate архитектора → перевод 🚧→✅.
