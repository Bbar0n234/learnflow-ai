...
- [x] Тест-кейсы на затронутые участки составлены и прогнаны (33 кейса, независимый агент-тестировщик на docker-стенде; 30 PASS / 3 SKIP без LLM-ключей); точечные автотесты на критичные пути — `backend/tests/` (17 шт.).
