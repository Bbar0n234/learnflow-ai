...
- [design-brief.md](iterations/dogfooding/feat-008-oauth-auth-screens/design-brief.md) — финализирован: флоу, state-cookie, провайдер-слой, гео-gate, реестры ошибок и SIEM-событий, контракты, партиция T1/T2; открытые вопросы взятия в работу (state-хранение, shape callback-пути, контракт providers) закрыты в нём; ревью свежим агентом пройдено (15 находок, вправлены)
