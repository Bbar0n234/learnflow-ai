...
- **[Бэклог](backlog/)** - Текущие и архивные планы реализации
  - [Список задач](backlog/tasklist.md) - Единый иерархический список всех задач и инициатив
...
### Управление проектом
- **[Список задач](backlog/tasklist.md)** - Сводка по всем инициативам и их статусам
...
- **"Что разрабатывается дальше?"** → [Список задач](backlog/tasklist.md)
...
- Обновляйте [Список задач](backlog/tasklist.md) при добавлении новых инициатив
