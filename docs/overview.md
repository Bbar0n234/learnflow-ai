...
- 📚 **Генерация обучающих материалов**: Создание исчерпывающих учебных материалов по любым дисциплинам на основе экзаменационных вопросов
...
- **InputProcessingNode** (`nodes/input_processing.py`) - анализ входных данных с валидацией экзаменационных вопросов
...
### 4. **Система безопасности** (`learnflow/security/`)
...
- **Защищенные входы:**
  - Экзаменационные вопросы (InputProcessingNode)
...
### 5. **Управление состоянием** (`learnflow/state.py`)
...
9. **Сохранение**: Автоматическое сохранение в GitHub (опционально)
