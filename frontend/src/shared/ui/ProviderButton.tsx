...
// Пути и цвета — дословно из mockups/ui-polish.html (секция 7, строки 441–454).
// Хардкод hex ниже — санкционированное исключение из design-system.md § Границы
// (резолюция оркестратора 1, plan.md T6 § Open Questions): фирменные цвета бренда,
// не палитра продукта, темизации не подлежат. Больше нигде в файле hex нет.
...
function GitHubIcon() {
  return (
    <svg className="size-5" viewBox="0 0 16 16" aria-hidden="true">
      {/* Брендовый цвет знака GitHub — из мокапа для обеих тем (не currentColor, plan-review #3) */}
      <path
        className="fill-[#24292f] dark:fill-[#f0f0f0]"
        fillRule="evenodd"
        clipRule="evenodd"
...
function YandexIcon() {
  return (
    <svg className="size-5" viewBox="0 0 24 24" aria-hidden="true">
      <circle cx="12" cy="12" r="11.5" fill="#fff" stroke="rgba(0,0,0,0.14)" />
      <text
        x="12.6"
        y="12.6"
        textAnchor="middle"
