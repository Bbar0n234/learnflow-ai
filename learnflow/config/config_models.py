...
class ModelConfig(BaseModel):
    ...
    top_p: Optional[float] = Field(default=None, ge=0.0, le=1.0, description="Top-p parameter")
...
class LLMModelsConfig(BaseModel):
    ...
    nodes: Dict[str, ModelConfig] = Field(default_factory=dict, description="Per-node model configurations")
...
class GraphConfig(BaseModel):
    ...
    graph_config: Optional[Dict] = Field(default=None, description="Additional graph configuration")